(function ($) {
    ...
    $(document).on('click', '#placeOrder', function (e) {
        ...
        const search_table_number = $('#search_table_number').val();
        sendAjaxRequest({
            url: orderAddUrl, data: {
                user_id: user_id,
                search_table_number: search_table_number,
    ...
    $(document).on('click', '.submit-button', function (e) {
        ...
        const form = $(this).closest('form'); // Find closest form
        const url = cartCustomUpdateQuantityUrl; // Your AJAX URL
    ...
    $(document).on('click', '.select-product', function (e) {
        ...
        sendAjaxRequest({
            url: cartUrl,
            data: { product_id: productId, type_id: type_id },
            reloadTable: ['#cart_list', '#cart_checkout']
        }).then(() => {
